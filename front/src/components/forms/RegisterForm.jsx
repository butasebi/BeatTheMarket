...
import { Heading, Text, HStack, VStack, FormControl, FormLabel, 
  Input, Checkbox, Button, Box, FormErrorMessage, FormHelperText } from '@chakra-ui/react';
import { Modal, ModalOverlay, ModalContent, ModalBody, 
  ModalCloseButton, useDisclosure, InputGroup, InputRightElement } from '@chakra-ui/react';
...
export default function RegisterForm() {
  ...
  function validatePassword(value) {
    ...
    } else if (!value.match(/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{8,30}$/g)) {
                  ...
                  <Form align='center'>
                        ...
                        <Field name='firstName'>
                          {({field, form}) => (
                            <FormControl isRequired isInvalid={form.errors.firstName && form.touched.firstName}>
                              ...
                              <Input {...field} ref={initialRef} variant='filled' />
                          ...
                          <FormControl isInvalid={form.errors.password && form.touched.password}>
                            ...
                            <InputGroup>
                              ...
                              <InputRightElement width='4.5rem'>
                                <Button size='sm' bg='white' borderRadius={10} onClick={handleClick}>
                                  {showPassword ? 'Hide' : 'Show'}
                                </Button>
                              </InputRightElement>
                            </InputGroup>
                            <FormHelperText align='justify'>Password should consist of at least 8 characters, 
                              including capital letters (A-Z), digits (0-9) and special symbols (!@#$%^&*).</FormHelperText>
                    ...
                    <Box mt='2vh' mb='1vh' align='left'>
                      <Field name='agreement'>
                        {({field, form}) => (
                          <FormControl isRequired isInvalid={form.errors.agreement && form.touched.agreement}>
                            <Checkbox {...field}>
